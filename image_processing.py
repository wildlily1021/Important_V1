...
def process_image(image_number):
    # Load the image
    image_path = f'D:/postgraduate/AI_SIGNAL_ANA/pythonProject/photo{image_number}.jpg'
    output_path = f'D:/postgraduate/AI_SIGNAL_ANA/pythonProject/photo{image_number}_nowhite.jpg'
    binary_output_path = f'D:/postgraduate/AI_SIGNAL_ANA/pythonProject/photo{image_number}_binary.jpg'
    black_output_path = f'D:/postgraduate/AI_SIGNAL_ANA/pythonProject/photo{image_number}_analy.jpg'
    ...
    # Find all non-white points (grayscale value less than the threshold)
...
#        global bandwidth, center_frequency
        write_to_excel(image_number, black_top, black_bottom, bandwidth, center_frequency)
