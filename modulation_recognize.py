...
def signal_create_test(Fs, Fc, Rs, SNR, Modulation):
    ...
    signal_wave = data_modu * np.exp(1j * 2 * np.pi * Fc * t)
...
cum20_matrix = np.zeros((8, 42), dtype=complex)
cum21_matrix = np.zeros((8, 42), dtype=complex)
cum40_matrix = np.zeros((8, 42), dtype=complex)
cum41_matrix = np.zeros((8, 42), dtype=complex)
cum42_matrix = np.zeros((8, 42), dtype=complex)
cum60_matrix = np.zeros((8, 42), dtype=complex)
cum61_matrix = np.zeros((8, 42), dtype=complex)
cum62_matrix = np.zeros((8, 42), dtype=complex)
cum63_matrix = np.zeros((8, 42), dtype=complex)
cum80_matrix = np.zeros((8, 42), dtype=complex)
